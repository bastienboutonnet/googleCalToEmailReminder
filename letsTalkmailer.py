...
WHERE_DOES_THE_MAIL_GO_TO = "lacg_letstalk@googlegroups.com"
...
def send_email(serviceMail,tomorrow,start,place,title,abstract):
	...
	if date == tomorrow.strftime('%A %d %B'):
		...
		body_tag = "Tomorrow we have an LACG-Let's Talk meeting\n\n"
		dotorbang = '!'
	if place != '':
	...
	body = "Dear LACG-Let's Talk members,\n\n" + body_tag + "\n\n" + place + '\n\nTime: ' + time + "\n\n" + abstract #+ "\n\nBest,\nBastien, Min, Yifei, and Cesko"
...
def main():
	...
	eventsResult = serviceCal.events().list(
		calendarId='grja5vt03qbl6h3qlo2hqbehmg@group.calendar.google.com', timeMin=lim_beg, timeMax=lim_end, singleEvents=True,
